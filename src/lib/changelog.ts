...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    description: "Erstes lauffähiges Xcode-Projekt fuer die native iOS-Companion-App mit SwiftUI, SwiftData-Modellen, Keychain-gesicherten API-Tokens, APIClient, AuthManager und ersten Uebersichts-Ansichten.",
    changes: [
      ...
      { type: "feature", text: "KeychainManager und AuthManager fuer sichere Token-Speicherung und Anmeldung" },
      { type: "feature", text: "SwiftData-Modelle fuer Spiele, Sessions, Events, Gruppen, Benutzer und Sync-Metadaten" },
