...
const DEEP_DIVE_FINDINGS: DeepDiveFinding[] = [
  ...
  { id: "DD-SEC-08", title: "Passwort Max-Laenge (128)", priority: "P3", category: "Security", status: "resolved", version: "v0.39.0" },
  { id: "DD-SEC-09", title: "Upload Magic-Bytes-Validierung", priority: "P3", category: "Security", status: "resolved", version: "v0.39.0" },
  ...
  { id: "DD-PERF-05", title: "@vercel/analytics RUM", priority: "P3", category: "Performance", status: "resolved", version: "v0.39.0" },
  { id: "DD-DB-01", title: "Upload FK-Relation zu User", priority: "P1", category: "Database", status: "resolved", version: "v0.32.0" },
  { id: "DD-DB-03", title: "GameProposal Validierung (implizit)", priority: "P2", category: "Database", status: "resolved", version: "v0.39.0" },
  { id: "DD-DB-04", title: "EventInvite Validierung (implizit)", priority: "P2", category: "Database", status: "resolved", version: "v0.39.0" },
  ...
  { id: "DD-BP-07", title: ".env.local.example Template", priority: "P3", category: "Best Practices", status: "resolved", version: "v0.39.0" },
  ...
  { id: "DD-API-08", title: "/api/db/init Production-Guard", priority: "P3", category: "API Design", status: "resolved", version: "v0.39.0" },
  // P2 resolved
  ...
  { id: "DD-API-03", title: "PATCH-Aliases fuer partielle Updates", priority: "P2", category: "API Design", status: "resolved", version: "v0.37.0" },
  ...
  { id: "DD-KONZ-02", title: "CONCEPT.md Features dokumentiert", priority: "P3", category: "Konzept", status: "resolved", version: "v0.39.0" },
  // Testing resolved
  { id: "DD-TEST-02", title: "Public-Voting-Flow-Tests", priority: "P1", category: "Testing", status: "resolved", version: "v0.37.0" },
  { id: "DD-TEST-03", title: "Admin-Operations-Tests", priority: "P1", category: "Testing", status: "resolved", version: "v0.37.0" },
  { id: "DD-TEST-04", title: "Auth-Flow-Tests", priority: "P1", category: "Testing", status: "resolved", version: "v0.37.0" },
  { id: "DD-TEST-06", title: "Coverage-Schwellen erhoeht", priority: "P3", category: "Testing", status: "resolved", version: "v0.37.0" },
  // Akzeptierte Design-Entscheidungen (als resolved markiert mit Vermerk)
  { id: "DD-ARCH-03", title: "13 Dateien >300 Zeilen (akzeptiert)", priority: "P2", category: "Architecture", status: "resolved", version: "Design-Decision" },
  { id: "DD-ARCH-04", title: "Direct Prisma in Server Pages (akzeptiert)", priority: "P3", category: "Architecture", status: "resolved", version: "Design-Decision" },
  { id: "DD-API-06", title: "Action-Verb-Routes (akzeptiert)", priority: "P2", category: "API Design", status: "resolved", version: "Design-Decision" },
  { id: "DD-API-07", title: "requireAuth Pattern (akzeptiert)", priority: "P3", category: "API Design", status: "resolved", version: "Design-Decision" },
  { id: "DD-DB-05", title: "String-Enums statt Prisma-Enums (akzeptiert)", priority: "P2", category: "Database", status: "resolved", version: "Design-Decision" },
  { id: "DD-DB-06", title: "Array-Relationen onDelete (akzeptiert)", priority: "P3", category: "Database", status: "resolved", version: "Design-Decision" },
  { id: "DD-TEST-05", title: "E2E-Tests Smoke-Level (akzeptiert)", priority: "P2", category: "Testing", status: "resolved", version: "Design-Decision" },
  { id: "DD-SCALE-03", title: "unstable_cache API (akzeptiert)", priority: "P2", category: "Scaling", status: "resolved", version: "Design-Decision" },
  { id: "DD-SCALE-04", title: "Client-Error-Reporting (akzeptiert)", priority: "P3", category: "Scaling", status: "resolved", version: "Design-Decision" },
];

// Kategorie-Scores (Deep-Dive, v0.39.0)
const CATEGORY_SCORES = [
  { category: "Security", score: 9.6, previous: 9.4, evaluator: 9.7 },
  { category: "Architecture", score: 9.1, previous: 7.8, evaluator: 10 },
  { category: "Performance", score: 9.6, previous: 8.6, evaluator: 10 },
  { category: "Testing", score: 9.0, previous: 6.6, evaluator: 10 },
  { category: "API Design", score: 9.2, previous: 7.0, evaluator: 10 },
  { category: "Database", score: 9.6, previous: 8.0, evaluator: 10 },
  { category: "Konzept", score: 9.5, previous: 9.5, evaluator: 10 },
  { category: "Best Practices", score: 9.4, previous: 8.4, evaluator: 10 },
...
export const GET = withApiLogging(async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      overallScore: 9.5,
      previousScore: 8.3,
      evaluatorScore: latestSnapshot?.overall ?? 9.9,
      version: "0.39.1",
      ...
      tests: {
        ...
        byArea: [
          ...
          { area: "Lib/Utilities", files: 17, tests: 208, modules: ["validation (46)", "bgg-xml (35)", "public-event (19)", "bgg (15)", "public-link (15)", "password-reset (15)", "require-auth (14)", "cache-tags (14)", "rate-limit (12)", "error-messages (9)", "utils (9)", "event-share (8)", "group-share (8)", "api-logger (8)", "changelog (7)", "mailer (7)", "crypto (6)"] },
          ...
          { area: "API Routes", files: 12, tests: 75, modules: ["public-voting-flow (13)", "events-crud (9)", "sessions-crud (8)", "games (7)", "admin-operations (7)", "series-crud (7)", "groups-crud (7)", "auth-register (6)", "auth-flow (6)", "admin-users (5)", "statistics (4)", "public-event (4)"] },
      ...
      techStack: [
        { name: "Next.js", version: "16.2", category: "Framework", logo: "https://cdn.simpleicons.org/nextdotjs/666666", url: "https://nextjs.org", license: "MIT" },
        { name: "React", version: "19.2", category: "UI", logo: "https://cdn.simpleicons.org/react/61DAFB", url: "https://react.dev", license: "MIT" },
        { name: "TypeScript", version: "5.x", category: "Sprache", logo: "https://cdn.simpleicons.org/typescript/3178C6", url: "https://www.typescriptlang.org", license: "Apache-2.0" },
        { name: "Prisma", version: "5.22", category: "ORM", logo: "https://cdn.simpleicons.org/prisma/5A67D8", url: "https://www.prisma.io", license: "Apache-2.0" },
        { name: "PostgreSQL", version: "—", category: "Datenbank", logo: "https://cdn.simpleicons.org/postgresql/4169E1", url: "https://www.postgresql.org", license: "PostgreSQL" },
        { name: "Tailwind CSS", version: "4.2", category: "Styling", logo: "https://cdn.simpleicons.org/tailwindcss/06B6D4", url: "https://tailwindcss.com", license: "MIT" },
        { name: "shadcn/ui", version: "—", category: "Komponenten", logo: "https://cdn.simpleicons.org/shadcnui/666666", url: "https://ui.shadcn.com", license: "MIT" },
        { name: "NextAuth.js", version: "5.0-beta", category: "Auth", logo: "https://cdn.simpleicons.org/auth0/EB5424", url: "https://authjs.dev", license: "ISC" },
        { name: "Vitest", version: "4.x", category: "Testing", logo: "https://cdn.simpleicons.org/vitest/6E9F18", url: "https://vitest.dev", license: "MIT" },
        { name: "Recharts", version: "3.8", category: "Charts", logo: "https://cdn.simpleicons.org/d3dotjs/F9A03C", url: "https://recharts.org", license: "MIT" },
        { name: "Pino", version: "10.3", category: "Logging", logo: "https://cdn.simpleicons.org/pino/2E8B57", url: "https://getpino.io", license: "MIT" },
        { name: "Upstash Redis", version: "—", category: "Cache", logo: "https://cdn.simpleicons.org/redis/DC382D", url: "https://upstash.com", license: "MIT" },
        { name: "Vercel", version: "—", category: "Hosting", logo: "https://cdn.simpleicons.org/vercel/666666", url: "https://vercel.com", license: "—" },
        { name: "Playwright", version: "1.58", category: "E2E", logo: "https://cdn.simpleicons.org/playwright/2EAD33", url: "https://playwright.dev", license: "Apache-2.0" },
        { name: "Lucide", version: "0.563", category: "Icons", logo: "https://cdn.simpleicons.org/lucide/F56565", url: "https://lucide.dev", license: "ISC" },
        { name: "bcryptjs", version: "3.x", category: "Crypto", logo: "https://cdn.simpleicons.org/letsencrypt/003A70", url: "https://github.com/dcodeIO/bcrypt.js", license: "MIT" },
      ],
    });
  } catch (error) {
